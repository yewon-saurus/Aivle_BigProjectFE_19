...
const SocialNaver = ()=>
{
    ...
    return(
    <>
    <button onClick={handleLogin} type='button' className='w-full mt-2 grid grid-cols-[10%_90%] place-items-center p-2 text-black/[0.85] bg-[#03C75A] rounded-xl border border-[#03C75A] hover:text-[#03C75A] hover:bg-white'>       
